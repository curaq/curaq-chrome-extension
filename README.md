...
1. 保存したい記事を開く
2. 以下のいずれかの方法で保存：
   - **右クリックメニュー**: ページ上で右クリック → 「CuraQに保存」を選択 → 確認画面で「送信」
   - **拡張アイコン**: ブラウザツールバーの拡張アイコンをクリック → 「この記事を保存」 → 確認画面で「送信」
...
**Proプラン（APIトークン設定時）**
- 右クリックメニュー: 確認ページを新しいタブで開き、内容を確認
- 拡張アイコン: ポップアップ内で保存内容を確認
- いずれもURLとタイトルのみ送信（ページ内容は送信されません）
- 確認後、即座に保存完了
